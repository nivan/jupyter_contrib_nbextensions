  ...
  <div class="legendItem">
   ...
   <div class="legendItem">
    ...
    var create_toc_div = function (cfg, st) {
        ...
        //
        var mainDiv = d3.select('#toc');
        installInterface(mainDiv);

        // d3.select('#toc').append('div').append('svg').attr('id', 'dagCanvas').attr('width', 300).attr('height', 300);
        // //
        // var detailsDiv = d3.select('#toc').append('div').attr('id', 'detailsDiv');
        // var mainDetailsDiv = detailsDiv.append('div')
        //     .attr('class', "w3-border")
        //     .attr('style', "width:300px;display: grid;grid-template-columns: 1fr 9fr;vertical-align: middle;");
        // //
        // mainDetailsDiv.append('label').text('Widget: ');
        // mainDetailsDiv.append('label').attr('id', 'widgetNameForm');
        // //
        // mainDetailsDiv.append('label').text('Progress: ');
        // mainDetailsDiv.append('div').attr('class', "w3-grey w3-center")
        //     .attr("style", "height:24px;width:100%").text('100%');
    ...
    var table_of_contents = function (cfg, st) {
        ...
        //         .on('click', function () {
        //             console.log('click', d3.select(this).select('circle').attr('id'));
        //         });
